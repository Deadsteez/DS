...
struct Node {
    int data;   // Single digit
    struct Node* next;
    struct Node* prev;
};

// Function to create a number (doubly linked list of digits)
...
// Function to display the number represented by the doubly linked list
...
// Function to subtract two numbers represented by doubly linked lists (num1 >= num2)
